...
} from "./plasmic/theme_switcher/PlasmicSection2";
...
function Section2_(props: Section2Props, ref: HTMLElementRefOf<"section">) {
  ...
  return <PlasmicSection2 section2={{ ref }} {...props} />;
}
