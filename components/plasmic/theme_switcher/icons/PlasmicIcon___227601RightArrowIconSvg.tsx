...
export type _227601RightArrowIconSvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function _227601RightArrowIconSvgIcon(
  props: _227601RightArrowIconSvgIconProps
) {
...
export default _227601RightArrowIconSvgIcon;
/* prettier-ignore-end */
