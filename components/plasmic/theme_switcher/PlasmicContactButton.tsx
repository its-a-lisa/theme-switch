...
import sty from "./PlasmicContactButton.module.css"; // plasmic-import: NaJAEQrwQJhK/css
...
export type PlasmicContactButton__VariantMembers = {
...
export type PlasmicContactButton__VariantsArgs = {
...
type VariantPropType = keyof PlasmicContactButton__VariantsArgs;
export const PlasmicContactButton__VariantProps = new Array<VariantPropType>(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "shape",
...
export type PlasmicContactButton__ArgsType = {
  link?: string;
  submitsForm?: boolean;
  target?: boolean;
...
type ArgPropType = keyof PlasmicContactButton__ArgsType;
export const PlasmicContactButton__ArgProps = new Array<ArgPropType>(
  "link",
  "submitsForm",
  "target",
  "startIcon",
...
export type PlasmicContactButton__OverridesType = {
  root?: Flex__<"button">;
...
export interface DefaultContactButtonProps extends pp.BaseButtonProps {
  submitsForm?: boolean;
  target?: boolean;
  shape?: SingleChoiceArg<"rounded" | "round" | "sharp">;
  size?: SingleChoiceArg<"compact" | "minimal">;
...
function PlasmicContactButton__RenderFunc(props: {
  variants: PlasmicContactButton__VariantsArgs;
  args: PlasmicContactButton__ArgsType;
  overrides: PlasmicContactButton__OverridesType;
  forNode?: string;
}) {
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg__nOa4X)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Icon4Icon
                className={classNames(projectcss.all, sty.svg__t1Mk5)}
                role={"img"}
              />
            ),
...
function useBehavior<P extends pp.PlumeButtonProps>(
  ...
  const b = pp.useButton<P, typeof PlasmicContactButton>(
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicContactButton__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicContactButton__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    /* Specify args directly as props*/ Omit<
      PlasmicContactButton__ArgsType,
      ReservedPropsType
    > &
